# -*- coding: utf-8 -*-
"""
Created on Tue Dec 17 13:54:18 2019
...
# 取到的图像是one_hot形式的图片，即在一个数组中
x = tf.placeholder(tf.float32, shape=[None, 784])
# reshape将数组转化成28*28的矩阵大小，即图片
...
# 第二层：这里为什么channel=32？
# 因为上一层生成了32个feature_map，channel=1（原始图片channel）*32（feature map数量）
...
# 第三层：7*7图片大小，因为需要做全连接层，需要将图片（矩阵）变成向量，reshape
# 还有没有别的方式进行这一层得到全连接层？
